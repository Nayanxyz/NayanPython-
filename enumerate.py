...
while True :
    ...
    match user:
        ...
        case "show" | "Show":
            for symb, item in enumerate(todos):   #symb is variable for number ,enumerate function used to add numbers,
                print(symb , '-',item)            #and symbol before strings. {symb = symbol & item = strings}
